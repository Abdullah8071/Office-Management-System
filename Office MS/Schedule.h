...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->tabControl1->Click += gcnew System::EventHandler(this, &Schedule::Schedule_Load_1);
			// 
			// tabPage1
			// 
			...
			this->dataGridView1->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &Schedule::dataGridView1_CellContentClick);
			// 
			// tabPage2
			// 
			...
			this->textBox5->Font = (gcnew System::Drawing::Font(L"Tahoma", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->textBox5->Location = System::Drawing::Point(976, 223);
			...
			this->label15->Font = (gcnew System::Drawing::Font(L"Tahoma", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->label15->Location = System::Drawing::Point(791, 223);
			this->label15->Name = L"label15";
			this->label15->Size = System::Drawing::Size(95, 25);
			this->label15->TabIndex = 77;
			this->label15->Text = L"Sunday :";
			// 
			// textBox1
			// 
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Tahoma", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->textBox1->Location = System::Drawing::Point(498, 372);
			...
			this->comboBox1->Items->AddRange(gcnew cli::array< System::Object^  >(4) {L"Admin", L"Inventory Clerk\t", L"Accountant", 
				L"Receptionist"});
			this->comboBox1->Location = System::Drawing::Point(498, 133);
			...
			this->textBox7->Font = (gcnew System::Drawing::Font(L"Tahoma", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->textBox7->Location = System::Drawing::Point(498, 277);
			...
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Tahoma", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->textBox2->Location = System::Drawing::Point(498, 85);
			...
			this->label9->Size = System::Drawing::Size(103, 25);
			...
			this->label10->Size = System::Drawing::Size(133, 25);
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Tahoma", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(324, 83);
			...
			this->linkLabel4->LinkClicked += gcnew System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, &Schedule::linkLabel4_LinkClicked);
			// 
			// linkLabel2
			// 
			...
			this->linkLabel2->LinkClicked += gcnew System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, &Schedule::linkLabel2_LinkClicked);
			// 
			// linkLabel1
			// 
			...
			this->linkLabel1->LinkClicked += gcnew System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, &Schedule::linkLabel1_LinkClicked);
			// 
			// linkLabel3
			// 
			...
			this->linkLabel3->LinkClicked += gcnew System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, &Schedule::linkLabel3_LinkClicked);
			// 
			// label2
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Tahoma", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(324, 133);
			...
			// rectangleShape1
			// 
			this->rectangleShape1->Location = System::Drawing::Point(289, 11);
			...
			this->Load += gcnew System::EventHandler(this, &Schedule::Schedule_Load_1);
	...
	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) 
			...
			else if(textBox17->Text!="\0"&&textBox17->Text!="")
			{
				try
				{
					...
					MySqlCommand^ cmdDataBase = gcnew MySqlCommand("SELECT* from `schedule1` where ID = '"+ID+"' ;",conDataBase);
					conDataBase->Open();
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) 
		 {
			 if(comboBox1->Text=="\0"||textBox2->Text=="\0"||textBox3->Text=="\0"||textBox4->Text=="\0"|| textBox5->Text=="\0"||textBox6->Text=="\0"||textBox7->Text=="\0"|| textBox8->Text=="\0"||textBox9->Text=="\0"||textBox10->Text=="\0"||textBox11->Text=="\0")
			{
				MessageBox::Show("One or more text field(s) is empty","Error", MessageBoxButtons::OKCancel,MessageBoxIcon::Asterisk);
				this->AcceptButton = button1;		
			}
			else if(comboBox1->Text==""||textBox2->Text==""||textBox3->Text==""||textBox4->Text==""|| textBox5->Text==""||textBox6->Text==""||textBox7->Text==""|| textBox8->Text==""||textBox9->Text==""||textBox10->Text==""||textBox11->Text=="")
			{
				MessageBox::Show("One or more text field(s) is empty","Error", MessageBoxButtons::OKCancel,MessageBoxIcon::Asterisk);
				this->AcceptButton = button1;			
			}
			else if(comboBox1->Text!="\0"&&textBox2->Text!="\0"&&textBox3->Text!="\0"&&textBox4->Text!="\0"&&textBox5->Text!="\0"&& textBox6->Text!="\0"&&textBox7->Text!="\0"&& textBox8->Text!="\0"&&textBox9->Text!="\0"&&textBox10->Text!="\0"&&textBox11->Text!="\0")
			{
					if(button1->Text=="Add")
					{
						try
						{
							...
							String^ Attendence = (textBox7->Text);
							String^ Monday = (textBox6->Text);
							String^ Tuesday = (textBox1->Text);
							String^ Wednesday = (textBox8->Text);
							String^ Thursday = (textBox9->Text);
							String^ Friday = (textBox10->Text);
							String^ Saturday = (textBox11->Text);
							String^ Sunday = (textBox5->Text);
		
							MySqlCommand^ cmdDataBase = gcnew MySqlCommand("INSERT INTO `schedule1` (`ID`,`Designation`,`First Name`,`Last Name`,`Attendence`,`Monday`,`Tuesday`,`Wednesday`, `Thursday`,`Friday`,`Saturday`, `Sunday`) VALUES ('"+ID+"','"+Designation+"', '"+FirstName+"','"+LastName+"','"+Attendence+"','"+Monday+"','"+Tuesday+"','"+Wednesday+"','"+Thursday+"','"+Friday+"','"+Saturday+"','"+Sunday+"');",conDataBase);
							MySqlDataReader^ Reader;
							conDataBase->Open();
							Reader=cmdDataBase->ExecuteReader();
					...
					else if(button1->Text=="Update")
					{
						...
						else if(textBox17->Text!="\0"&&textBox17->Text!="")
						{
							try
							{
								...
								MySqlCommand^ cmdDataBase = gcnew MySqlCommand("UPDATE `schedule1` SET `ID` = '"+ID+"',`Designation`= '"+Designation+"',`First Name`= '"+FirstName+"', `Last Name`= '"+LastName+"', `Attendence`= '"+Attendence+"',`Monday`= '"+Monday+"', `Tuesday`= '"+Tuesday+"', `Wednesday`= '"+Wednesday+"', `Friday`= '"+Friday+"', `Saturday`= '"+Saturday+"', `Sunday`= '"+Sunday+"' where ID = '"+Id+"' ;",conDataBase);
								conDataBase->Open();
								MySqlDataReader^ Reader;
								Reader=cmdDataBase->ExecuteReader();
					...
					else if(button1->Text=="Delete")
					{
						...
						else if(textBox17->Text!="\0"&&textBox17->Text!="")
						{
							...
							String^ constring="server=localhost;user id=root;database=oms_database";
							MySqlConnection^ conDataBase=gcnew MySqlConnection(constring);
							MySqlCommand^ cmdDataBase = gcnew MySqlCommand("DELETE from `schedule1` where ID = '"+ID+"' ;",conDataBase); 
							conDataBase->Open();
							MySqlDataReader^ Reader;
							Reader=cmdDataBase->ExecuteReader();
...
private: System::Void Schedule_Load_1(System::Object^  sender, System::EventArgs^  e) 
		 {
			String^ constring="server=localhost;user id=root;database=oms_database";
			MySqlConnection^ conDataBase=gcnew MySqlConnection(constring);
