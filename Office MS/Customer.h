...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(507, 92);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(351, 30);
			this->label1->TabIndex = 56;
			this->label1->Text = L"Customer Management";
			...
			this->tabControl1->Click += gcnew System::EventHandler(this, &Customer::Customer_Load);
			// 
			// tabPage1
			// 
			...
			this->comboBox2->Location = System::Drawing::Point(498, 370);
			...
			this->comboBox1->Items->AddRange(gcnew cli::array< System::Object^  >(2) {L"Dealer", L"End User"});
			...
			this->label14->Size = System::Drawing::Size(174, 25);
			...
			this->button1->Click += gcnew System::EventHandler(this, &Customer::button1_Click_1);
			// 
			// label12
			// 
			...
			this->label8->Size = System::Drawing::Size(62, 25);
			...
			this->linkLabel4->LinkClicked += gcnew System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, &Customer::linkLabel4_LinkClicked);
			// 
			// linkLabel2
			// 
			...
			this->linkLabel2->LinkClicked += gcnew System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, &Customer::linkLabel2_LinkClicked);
			// 
			// linkLabel1
			// 
			...
			this->linkLabel1->LinkClicked += gcnew System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, &Customer::linkLabel1_LinkClicked);
			// 
			// linkLabel3
			// 
			...
			this->linkLabel3->LinkClicked += gcnew System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, &Customer::linkLabel3_LinkClicked);
			// 
			// label2
			// 
...
private: System::Void Customer_Load(System::Object^  sender, System::EventArgs^  e) 
		 {
			...
			MySqlDataAdapter^ sda= gcnew MySqlDataAdapter("SELECT * FROM `customer`;",conDataBase);
...
private: System::Void button1_Click_1(System::Object^  sender, System::EventArgs^  e) 
		 {
			if(comboBox1->Text=="\0"||textBox2->Text=="\0"||textBox3->Text=="\0"||textBox4->Text=="\0"||comboBox2->Text=="\0"|| textBox6->Text=="\0"||textBox7->Text=="\0"|| textBox8->Text=="\0"||textBox9->Text=="\0"||textBox10->Text=="\0"||textBox11->Text=="\0")
			{
				MessageBox::Show("One or more text field(s) is empty","Error", MessageBoxButtons::OKCancel,MessageBoxIcon::Asterisk);
				this->AcceptButton = button1;		
			}
			else if(comboBox1->Text==""||textBox2->Text==""||textBox3->Text==""||textBox4->Text==""||comboBox2->Text==""|| textBox6->Text==""||textBox7->Text==""|| textBox8->Text==""||textBox9->Text==""||textBox10->Text==""||textBox11->Text=="")
			{
				MessageBox::Show("One or more text field(s) is empty","Error", MessageBoxButtons::OKCancel,MessageBoxIcon::Asterisk);
				this->AcceptButton = button1;			
			}
			else if(comboBox1->Text!="\0"&&textBox2->Text!="\0"&&textBox3->Text!="\0"&&textBox4->Text!="\0"&&comboBox2->Text!="\0"&& textBox6->Text!="\0"&&textBox7->Text!="\0"&& textBox8->Text!="\0"&&textBox9->Text!="\0"&&textBox10->Text!="\0"&&textBox11->Text!="\0")
			{
					if(button1->Text=="Add")
					{
						try
						{
							...
							String^ CompanyName =(textBox11->Text);
			
		
							MySqlCommand^ cmdDataBase = gcnew MySqlCommand("INSERT INTO `customer` (`Type`, `ID`, `First Name`, `Last Name`, `Date Of Birth`, `Age`, `Gender`, `Phone`, `Address`, `Email`, `Company Name`) VALUES ('"+Type+"','"+ID+"', '"+FirstName+"','"+LastName+"','"+DateOfBirth+"','"+Age+"','"+Gender+"','"+Phone+"','"+Address+"','"+Email+"','"+CompanyName+"');",conDataBase);
					...
					else if(button1->Text=="Update")
					{
						...
						else if(textBox17->Text!="\0"&&textBox17->Text!="")
						{
							try
							{
								...
								MySqlCommand^ cmdDataBase = gcnew MySqlCommand("UPDATE `customer` SET `Type`='"+Type+"',`ID`='"+ID+"',`First Name`='"+FirstName+"',`Last Name`='"+LastName+"',`Date Of Birth`='"+DateOfBirth+"',`Age`='"+Age+"',`Gender`='"+Gender+"',`Phone`='"+Phone+"',`Address`='"+Address+"',`Email`='"+Email+"',`Company Name`='"+CompanyName+"' where ID = '"+Id+"' ;",conDataBase);
								conDataBase->Open();
								MySqlDataReader^ Reader;
								Reader=cmdDataBase->ExecuteReader();
					...
					else if(button1->Text=="Delete")
					{
						...
						else if(textBox17->Text!="\0"&&textBox17->Text!="")
						{
							...
							String^ constring="server=localhost;user id=root;database=oms_database";
							MySqlConnection^ conDataBase=gcnew MySqlConnection(constring);
							MySqlCommand^ cmdDataBase = gcnew MySqlCommand("DELETE from `customer` where ID = '"+ID+"' ;",conDataBase); 
							conDataBase->Open();
							MySqlDataReader^ Reader;
							Reader=cmdDataBase->ExecuteReader();
